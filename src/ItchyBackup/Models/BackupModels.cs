...
public partial class BackupItem : ObservableObject
{
    ...
    /// <summary>SVG path for brand logo — null ise kategori ikonu kullanılır</summary>
    public string? BrandLogoPath => Id switch
    {
        // Browsers
        "chrome"  => BrandLogos.Chrome,
        "firefox" => BrandLogos.Firefox,
        "edge"    => BrandLogos.Edge,
        "opera"   => BrandLogos.Opera,
        "brave"   => BrandLogos.Brave,
        "vivaldi" => BrandLogos.Vivaldi,
        // Cloud
        "onedrive"    => BrandLogos.OneDrive,
        "googledrive" => BrandLogos.GoogleDrive,
        "mega"        => BrandLogos.Mega,
        "dropbox"     => BrandLogos.Dropbox,
        _ => null
    };

    public bool HasBrandLogo => BrandLogoPath != null;
