...
OutputBaseFilename=ItchyBackup_v0.5_Setup
...
[Files]
Source: "..\build\publish_fd\ItchyBackup.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\build\publish_fd\*.dll"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "..\build\publish_fd\*.json"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
